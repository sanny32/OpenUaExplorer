...
#
# Enable with -DOUAEXP_ENABLE_COVERAGE=ON. Instrumentation is only applied to
# the targets passed to ouaexp_apply_coverage() (the testable library and the
...
option(OUAEXP_ENABLE_COVERAGE "Instrument the test targets for code coverage" OFF)

function(ouaexp_apply_coverage target)
    if(NOT OUAEXP_ENABLE_COVERAGE)
        return()
    endif()
    ...
    elseif(MSVC)
        ...
        message(WARNING "OUAEXP_ENABLE_COVERAGE: unsupported compiler "
