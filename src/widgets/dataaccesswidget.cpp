...
{
    ui->addNodeButton->setThemedIcon("add.svg");
    ui->removeButton->setThemedIcon("remove.svg");
    ui->readButton->setThemedIcon("read.svg");
    ui->writeButton->setThemedIcon("write.svg");
    ui->subscribeButton->setThemedIcon("subscribe.svg");
